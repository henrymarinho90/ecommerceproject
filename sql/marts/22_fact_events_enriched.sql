CREATE VIEW thelook_raw.v_fact_order_items_enriched AS
SELECT
  ...
  oi.created_at::timestamptz  AS created_at,
  oi.shipped_at::timestamptz  AS shipped_at,
  oi.delivered_at::timestamptz AS delivered_at,
  oi.returned_at::timestamptz AS returned_at,
